...
contract SluggishSloths is Ownable, ERC721, ERC721Enumerable {
    ...
    uint private _mintSharesLottery = 20;
 ...
 function teamPayout() public onlyOwner {
        payable(0x9e4A358854fE92d9bf17af6672503c38C52561D5).transfer((_balanceTeam*25)/100);
        payable(0x963e27f48F692514CeFD88986B8ea8b043AFbCb1).transfer((_balanceTeam*75)/100);
    }
